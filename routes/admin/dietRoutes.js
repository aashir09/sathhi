...
const diet_1 = __importDefault(require("../../controllers/admin/diet"));
 ...
 */
// #endregion
router.post('/getDiet', diet_1.default.getDiet);
 ...
 */
// #endregion
router.post('/insertUpdateDiet', diet_1.default.insertUpdateDiet);
 ...
 * @apiError (400) {JSON} Result message, apiName, apiType, fileName, functionName, lineNumber, typeName, stack.
 * @apiErrorExample {json} Error-400-Response:
 *     HTTP/1.1 400 Error While Change Diet Status
 *     {
 *          status: 400,
 *          isDisplayMessage: <true/false>, // if the value is true then display message on screen
 *          message: "Error While Change Diet Status",
 *          error: {
 *              apiName: <api name>,
 *              apiType: <api type>,
 *              fileName: <file name>,
 ...
 */
// #endregion
router.post('/activeInactiveDiet', diet_1.default.activeInactiveDiet);
