...
import controller from '../../controllers/admin/currencies';
 ...
 */
// #endregion
router.post('/getCurrencies', controller.getCurrencies);
 ...
 */
// #endregion
router.post('/activeInactivecurrency', controller.activeInactiveCurrency);
 ...
 */
// #endregion
router.post('/setDefaultCurrency', controller.setDefaultCurrency);
