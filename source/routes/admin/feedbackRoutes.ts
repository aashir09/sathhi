...
// #region /api/admin/height/activeInactiveFeedback apidoc
/**
 * @api {post} /api/admin/feedback/activeInactiveFeedback Change Feedback
 * @apiVersion 1.0.0
 * @apiName Change Feedback
 * @apiDescription Change Feedback
 * @apiGroup Feedback - Admin
 * @apiParam  {Integer}         id                  Requires Feedback Id.
 ...
 *         "status": 200,
 *         "isDisplayMessage": true,
 *         "message": "Change Feedback Status",
 *         "recordList": {
 *             "fieldCount": 0,
 *             "affectedRows": 1,
 *             "insertId": 0,
 ...
 * @apiError (400) {JSON} Result message, apiName, apiType, fileName, functionName, lineNumber, typeName, stack.
 * @apiErrorExample {json} Error-400-Response:
 *     HTTP/1.1 400 Error While Change Feedback Status
 *     {
 *          status: 400,
 *          isDisplayMessage: <true/false>, // if the value is true then display message on screen
 *          message: "Error While Change Feedback Status",
 *          error: {
 *              apiName: <api name>,
 *              apiType: <api type>,
 *              fileName: <file name>,
 ...
 */
// #endregion
router.post('/activeInactiveFeedback', controller.activeInactiveFeedback);
