...
router.post('/generateMemberIdTestingAPI', controller.generateMemberIdTestingAPI);

router.post('/completeUserProfileV2', controller.completeUserProfileV2);

router.post('/TestingAPI', controller.TestingAPI);
