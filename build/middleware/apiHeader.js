...
const validateAuthorization = (request, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (request.headers['authorization'] != undefined && request.headers['authorization'] != '') {
        try {
            ...
            if (config_1.default.baseRequests.indexOf(requestUrl) == -1 || authorization) {
                try {
                    if (authorization != '') {
            ...
            statusCode = 500;
            message = error.message + "errorsss";
        }
    }
    else {
        statusCode = 401;
...
exports.default = { validateAuthorization, parseFieldValue, validateField, validateRequiredFields, query, beginTransaction, commit, rollback };
