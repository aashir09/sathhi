...
const occupation_1 = __importDefault(require("../../controllers/admin/occupation"));
 ...
 */
// #endregion
router.post('/getOccupation', occupation_1.default.getOccupation);
 ...
 */
// #endregion
router.post('/insertUpdateOccupation', occupation_1.default.insertUpdateOccupation);
 ...
 * @apiError (400) {JSON} Result message, apiName, apiType, fileName, functionName, lineNumber, typeName, stack.
 * @apiErrorExample {json} Error-400-Response:
 *     HTTP/1.1 400 Error While Change Occupation Status
 *     {
 *          status: 400,
 *          isDisplayMessage: <true/false>, // if the value is true then display message on screen
 *          message: "Error While Change Occupation Status",
 *          error: {
 *              apiName: <api name>,
 *              apiType: <api type>,
 *              fileName: <file name>,
 ...
 */
// #endregion
router.post('/activeInactiveOccupation', occupation_1.default.activeInactiveOccupation);
