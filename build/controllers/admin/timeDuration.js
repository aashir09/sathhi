        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                if (checkResult && checkResult.length > 0) {
                    let errorResult = new resulterror_1.ResultError(400, true, "Value Already Exist", new Error("Value Already Exist"), '');
                    next(errorResult);
                }
                else {
                    if (req.body.id) {
    ...
    try {
        ...
        if (validationResult && validationResult.statusCode == 200) {
            ...
            if (authorizationResult.statusCode == 200) {
                ...
                let sqlResult = yield apiHeader_1.default.query(checkSql);
